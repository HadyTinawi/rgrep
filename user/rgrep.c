// Recursive grep. Supports ^ . * $ operators like regular grep.
...
// Appends src string to end of dest string (xv6 doesn't have strcat)
void
...
// Search a single file for pattern matches, printing filename prefix with results
void
...
// Recursively search through a directory and its subdirectories
void
